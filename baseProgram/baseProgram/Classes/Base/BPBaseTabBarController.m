...
{
    BPMainPageViewController *mainPageVC = [BPMainPageViewController new];
    BPBaseNavigationController *nav = [[BPBaseNavigationController alloc]initWithRootViewController:mainPageVC];
    ...
    nav.tabBarItem =[[UITabBarItem alloc]initWithTitle:@"大厅" image:homeNorImage selectedImage:homeSelImage];
    
    BPNewListViewController *newsListVC = [BPNewListViewController new];
    BPBaseNavigationController *nav2 = [[BPBaseNavigationController alloc]initWithRootViewController:newsListVC];
    ...
    nav2.tabBarItem =[[UITabBarItem alloc]initWithTitle:@"爆料" image:newsNorImage selectedImage:newsSelImage];
    ...
    self.viewControllers = @[nav,nav2,nav1];
